...
df_restaurants = pd.read_csv(os.path.join(script_dir, "synthetic_data", "restaurants.csv"))
df_customers = pd.read_csv(os.path.join(script_dir, "synthetic_data", "customers.csv"))
df_menu_items = pd.read_csv(os.path.join(script_dir, "synthetic_data", "menu_items.csv"))
